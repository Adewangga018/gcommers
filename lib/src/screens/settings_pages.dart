            ...
            _InfoCard(
              children: isTransportir
                  ...
                  : [
                      ...
                      _InfoRow(label: 'Wilayah', value: s?.region),
                      _InfoRow(label: 'Provinsi', value: s?.provinsiNama),
                      _InfoRow(label: 'Kabupaten/Kota', value: s?.kabupatenNama),
                      _InfoRow(label: 'Kecamatan', value: s?.kecamatanNama, isLast: true),
                    ],
            ),
