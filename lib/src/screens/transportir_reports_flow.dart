...
class _TransportirReportsPageState extends State<TransportirReportsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: _TransportirReportBottomNav(currentIndex: 3, session: session),
    );
  }
}
...
class _TransportirReportBottomNav extends StatelessWidget {
  const _TransportirReportBottomNav({required this.currentIndex, this.session});
